...
export type GetClassLessonsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetClassLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, title: string, slug: string, availableAt?: any | null, lessonType: LessonType }> };
...
export const GetClassLessonsDocument = gql`
    query GetClassLessons {
...
/**
 * __useGetClassLessonsQuery__
 *
 * To run a query within a React component, call `useGetClassLessonsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClassLessonsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClassLessonsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetClassLessonsQuery(baseOptions?: Apollo.QueryHookOptions<GetClassLessonsQuery, GetClassLessonsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetClassLessonsQuery, GetClassLessonsQueryVariables>(GetClassLessonsDocument, options);
      }
export function useGetClassLessonsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetClassLessonsQuery, GetClassLessonsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetClassLessonsQuery, GetClassLessonsQueryVariables>(GetClassLessonsDocument, options);
        }
export type GetClassLessonsQueryHookResult = ReturnType<typeof useGetClassLessonsQuery>;
export type GetClassLessonsLazyQueryHookResult = ReturnType<typeof useGetClassLessonsLazyQuery>;
export type GetClassLessonsQueryResult = Apollo.QueryResult<GetClassLessonsQuery, GetClassLessonsQueryVariables>;
